...
use Apxiaoxv\Modules\Exceptions\InvalidAssetPath;
use Apxiaoxv\Modules\Exceptions\ModuleNotFoundException;
use Apxiaoxv\Modules\Process\Installer;
use Apxiaoxv\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @param string $args
     * @param string $path
     * @return \Apxiaoxv\Modules\Module
     */
     ...
     * @return string
     * @throws \Apxiaoxv\Modules\Exceptions\ModuleNotFoundException
     */
